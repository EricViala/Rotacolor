...
function bubblemouseenter(e) {
    ...
    if(bubble.nominalY + bubble.clientHeight < vh){
        console.log('top down');
        sty.borderTopLeftRadius = bubble.nominalR + 'px';
    }else{
        console.log('bottom up');
        sty.borderBottomLeftRadius = bubble.nominalR + 'px';
        sty.top = (bubble.nominalY -bubble.clientHeight + bubble.nominalR*2) +'px';
    }
 ...
 */
(function () {
    window.addEventListener('DOMContentLoaded', paintNamedColors);
    window.addEventListener('resize', paintNamedColors);
})();